...
LDFLAGS := -Wl,--no-entry -Wl,--export=__init_libc -Wl,--export=main -Wl,--export=exit -Wl,--allow-undefined-file=functions -Wl,--import-memory -Wl,--shared-memory -Wl,--max-memory=67108864 -L$(PWD)/musl/lib -L$(PWD)/compiler-rt/build/lib/generic -Wl,--whole-archive -lc -lclang_rt.builtins-wasm32
